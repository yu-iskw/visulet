---
name: visulet-chart-author
description: This skill should be used when authoring a Visulet ChartAssemblyInput, choosing chart types and encodings, or calling create_chart_view / render_chart / compile_chart. Trigger on "author a chart", "visulet chart", semantic_types, or chart_spec.
license: Apache-2.0
---
...
explicitly asks to compile. App embedders compile with `@visulet/sdk` in their
own process; agents keep using these MCP tools.
