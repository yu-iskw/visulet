---
name: visulet-theme-author
description: This skill should be used when authoring a Visulet ThemeSpec, choosing a preset id, or overriding ink, type, structure, marks, labels, legend, dataLabels, or layout. Trigger on "author a theme", "visulet theme", theme_spec, list_themes, or preset ids such as paper and slate.
license: Apache-2.0
---
